...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1 = new Customer("Wisconsin", "yoholebise@gmail.com", "Ahmet Said", "Tugrul", "DataB/52");
        Customer customer2 = new Customer("Illinois", "bluhbluh@gmail.com", "Baturay", "Gok", "syncrozine");
